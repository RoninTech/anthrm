...
static const GLfloat fountain_diffuse[4]  = {0.7f,1.0f,1.0f,1.0f};
static const GLfloat fountain_specular[4] = {1.0f,1.0f,1.0f,1.0f};
static const GLfloat fountain_shininess   = 12.0f;
static const GLfloat floor_diffuse[4]     = {1.0f,0.6f,0.6f,1.0f};
static const GLfloat floor_specular[4]    = {0.6f,0.6f,0.6f,1.0f};
static const GLfloat floor_shininess      = 18.0f;
static const GLfloat fog_color[4]		  = {0.1f, 0.1f, 0.1f, 1.0f};
...
static double t0;
static GLFWthread physics_thread = 0;
    
int GLParticlesInit (TFRAME *frame)
{
...
void GLParticlesDraw (TFRAME *frame)
{
...
void GLParticlesClose ()
{
	...
	glDeleteTextures(1, &particle_tex_id);
	glDeleteTextures(1, &floor_tex_id);
	
	floor_tex_id = 0;
	particle_tex_id = 0;

	glDeleteLists(fountain_list, 1);
	glDeleteLists(floor_list, 1);
