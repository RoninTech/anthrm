...
#define __BUILD_NULLDISPLAY__			1		// Template
#define __BUILD_NULLPORT__				1		// Template. Use with displays that no not require a port driver (DDRAW, SDL, G15, etc..)
#define __BUILD_FTDI__					1		// Access FTxxx devices through libftdi and libusb. Tested with FT245BM.
#define __BUILD_KS0108__				1
#define __BUILD_T6963C__				1
#define __BUILD_SED1335__				1		// S1D133x
#define __BUILD_SED1565__				1		// Found in Nokia 7110 (96x65)
#define __BUILD_PCD8544__				1		// Found in Nokia 3210, 3310, 5210, 8210 and others (usually 84x48)
#define __BUILD_PCF8814__				1		// Found in Nokia 3510, 6310, 5310 and others (usually 96x65)
#define __BUILD_PCF8833__				1		// Colour Nokia 6100, 6610, 7210, etc.. (usually 130x130)
#define __BUILD_S1D15G10__				1		// S1D15G00/10. Colour Nokia 6100, 6610, 7210, etc.. (usually 130x130)
#define __BUILD_S1D15G14__				1		// Found in Nokia 3510i (98x67)
...
#define __BUILD_USB13700EXP__			1		// USB13700 expansion port configured for SPI. port0:control:0x378+2, port1:SPI:0x378 (requires __BUILD_USB13700LIBUSB__ or __BUILD_USB13700DLL__)
#define __BUILD_USB13700LIBUSB__		1		// S1D13700/USB13700 accessed through libusb (display_lib_USB13700.dll not required)

#ifdef __WIN32__
#define __BUILD_USB13700DLL__			1		// S1D13700/USB13700 accessed through display_lib_USB13700.dll (is dynamically loaded)
...
#define __BUILD_USBD480__				1		// USBD480 through libusb0 and HID (composite interface).
...
#define __BUILD_FT245__					1		// requires FTD2XX.dll (is dynamically loaded)
#define __BUILD_WINIO__					1		// requires winio.sys
#define __BUILD_OPENPARPORT__			1
